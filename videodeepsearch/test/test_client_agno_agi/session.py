...
class Session:
    def __init__(self, user_id: str, session_id: str, chat_history: list[Message] | None = None):
    ...
    def from_dict(cls, data: dict) -> "Session":
        ...
        chat_histories = [Message.model_validate(chat) for chat in chat_history_raw]
