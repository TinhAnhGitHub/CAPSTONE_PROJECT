# """
# Validation runner for VideoDeepSearch agent testing.

# Provides end-to-end validation runs with MLflow tracing and dual output
...
# # from videodeepsearch.evaluation.util.agno_printer import print_run_event, _stream_flush
...
# mlflow.set_experiment("videodeepsearch-agent-validation")
...
#         mlflow.log_metric("team/input_tokens", session_metrics.input_tokens)
#         mlflow.log_metric("team/output_tokens", session_metrics.output_tokens)
#         mlflow.log_metric("team/total_tokens", session_metrics.total_tokens)
#         mlflow.log_metric("team/duration_seconds", duration_seconds)
#         if session_metrics.cost:
#             mlflow.log_metric("team/cost", session_metrics.cost)
...
#     output_dir = Path(__file__).parent.parent.parent.parent.parent / "validate" / "logs"
