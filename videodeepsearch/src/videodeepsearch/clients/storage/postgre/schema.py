...
class ArtifactMetadata(BaseModel):
    ...
    artifact_type: str = Field(
        ...,
        description="The type of the artifact, such as 'video', 'json', 'image', or 'caption'.",
    )
...
class ArtifactSchema(Base):
    """SQLAlchemy schema for artifacts table."""
...
__all__ = ["ArtifactMetadata", "ArtifactSchema", "ArtifactLineageSchema", "Base"]