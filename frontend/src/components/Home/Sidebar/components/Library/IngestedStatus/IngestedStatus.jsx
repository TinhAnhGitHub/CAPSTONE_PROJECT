...
export default function IngestedStatus({ percentage }) {
  return (
    // spinner with percentage at the middle
    <>
      {
        percentage != 100 ?
          <div className="relative flex items-center justify-center w-12 h-12">
          {/* fill the circle with percentage */}
            <div role="status">
            ...
            <div className="absolute text-sm font-semibold text-gray-950">{Math.round(percentage)}%</div>
          </div>
          :
          <></>
      }
